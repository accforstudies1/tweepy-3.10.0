...
class Stream(object):
    ...
    def userstream(self,
        ...
        self._start(is_async_)

    def firehose(self, count=None, is_async_=False):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def retweet(self, is_async_=False):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def sample(self, is_async_=False, languages=None, stall_warnings=False):
        self.session.params = {'delimited': 'length'}
        if self.running:
            raise TweepError('Stream object already connected!')
    ...
    def filter(self, follow=None, track=None, is_async_=False, locations=None,
    ...
    def sitestream(self, follow, stall_warnings=False,
                   with_='user', replies=False, is_async_=False):
        self.body = {}
        if self.running:
            raise TweepError('Stream object already connected!')
